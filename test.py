...
#Ne fillim te kodit deklarojme variablat e nevojshme
#me type-t perkatese dhe me vlerat ne varesi te biznesit qe behet fjale
...
meat:list[str]=["pork","chicken","beef","mix"]
pizza:list[str]=["margarita","diavola","caprese","capricosa"]
salads:list[str]=["cesar","rukola","greek","home made"]
drinks:list[str]=["cola","fanta","water","red bull "]
...
if(has_gluten_free):
    print("Po kemi pa ushqime pa gluten")
else:("Jo nuk kemi ushqime pa gluten")
